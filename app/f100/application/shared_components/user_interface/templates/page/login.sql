...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(3236176794634100)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3236474713634100)
,p_page_template_id=>wwv_flow_imp.id(3236176794634100)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3236750959634100)
,p_page_template_id=>wwv_flow_imp.id(3236176794634100)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3237086261634100)
,p_page_template_id=>wwv_flow_imp.id(3236176794634100)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3237302241634100)
,p_page_template_id=>wwv_flow_imp.id(3236176794634100)
,p_name=>'Body Footer'
