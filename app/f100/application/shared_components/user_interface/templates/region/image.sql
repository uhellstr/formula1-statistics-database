...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3270455768634111)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3270775586634111)
,p_plug_template_id=>wwv_flow_imp.id(3270455768634111)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3271096203634111)
,p_plug_template_id=>wwv_flow_imp.id(3270455768634111)
,p_name=>'Sub Regions'
