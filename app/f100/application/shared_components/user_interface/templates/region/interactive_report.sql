...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3286060200634114)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3286382720634114)
,p_plug_template_id=>wwv_flow_imp.id(3286060200634114)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3286606453634114)
,p_plug_template_id=>wwv_flow_imp.id(3286060200634114)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3286971528634114)
,p_plug_template_id=>wwv_flow_imp.id(3286060200634114)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3287254749634114)
,p_plug_template_id=>wwv_flow_imp.id(3286060200634114)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3287514955634114)
,p_plug_template_id=>wwv_flow_imp.id(3286060200634114)
,p_name=>'Sub Regions'
