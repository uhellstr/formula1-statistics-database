...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3248399272634105)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3248662332634105)
,p_plug_template_id=>wwv_flow_imp.id(3248399272634105)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3248939730634105)
,p_plug_template_id=>wwv_flow_imp.id(3248399272634105)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3249279026634105)
,p_plug_template_id=>wwv_flow_imp.id(3248399272634105)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3249510377634105)
,p_plug_template_id=>wwv_flow_imp.id(3248399272634105)
,p_name=>'Sub Regions'
