...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3290689298634115)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3290940959634116)
,p_plug_template_id=>wwv_flow_imp.id(3290689298634115)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3291261511634116)
,p_plug_template_id=>wwv_flow_imp.id(3290689298634115)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3291529459634116)
,p_plug_template_id=>wwv_flow_imp.id(3290689298634115)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3291809248634116)
,p_plug_template_id=>wwv_flow_imp.id(3290689298634115)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292127004634116)
,p_plug_template_id=>wwv_flow_imp.id(3290689298634115)
,p_name=>'Sub Regions'
