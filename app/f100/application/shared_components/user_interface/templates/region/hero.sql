...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3330059453634123)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3330350735634124)
,p_plug_template_id=>wwv_flow_imp.id(3330059453634123)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3330636131634124)
,p_plug_template_id=>wwv_flow_imp.id(3330059453634123)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3330981471634124)
,p_plug_template_id=>wwv_flow_imp.id(3330059453634123)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3331243930634124)
,p_plug_template_id=>wwv_flow_imp.id(3330059453634123)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3331561058634124)
,p_plug_template_id=>wwv_flow_imp.id(3330059453634123)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
