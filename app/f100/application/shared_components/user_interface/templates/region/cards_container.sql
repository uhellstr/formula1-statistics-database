...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3254080804634105)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3254345214634105)
,p_plug_template_id=>wwv_flow_imp.id(3254080804634105)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3254674454634105)
,p_plug_template_id=>wwv_flow_imp.id(3254080804634105)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3254941300634106)
,p_plug_template_id=>wwv_flow_imp.id(3254080804634105)
,p_name=>'Sub Regions'
