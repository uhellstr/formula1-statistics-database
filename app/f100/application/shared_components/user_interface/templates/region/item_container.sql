...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3288141243634114)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3288423787634115)
,p_plug_template_id=>wwv_flow_imp.id(3288141243634114)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3288797126634115)
,p_plug_template_id=>wwv_flow_imp.id(3288141243634114)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3289005716634115)
,p_plug_template_id=>wwv_flow_imp.id(3288141243634114)
,p_name=>'Button Start'
