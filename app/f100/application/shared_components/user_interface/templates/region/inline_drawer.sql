...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3275824983634112)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3276151871634112)
,p_plug_template_id=>wwv_flow_imp.id(3275824983634112)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3276419248634112)
,p_plug_template_id=>wwv_flow_imp.id(3275824983634112)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3276788354634112)
,p_plug_template_id=>wwv_flow_imp.id(3275824983634112)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3277064105634112)
,p_plug_template_id=>wwv_flow_imp.id(3275824983634112)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3277381980634112)
,p_plug_template_id=>wwv_flow_imp.id(3275824983634112)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3277608167634112)
,p_plug_template_id=>wwv_flow_imp.id(3275824983634112)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3277944559634112)
,p_plug_template_id=>wwv_flow_imp.id(3275824983634112)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3278299164634112)
,p_plug_template_id=>wwv_flow_imp.id(3275824983634112)
,p_name=>'Sub Regions'
