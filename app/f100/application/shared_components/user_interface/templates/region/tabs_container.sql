...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3305672891634119)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3305906509634120)
,p_plug_template_id=>wwv_flow_imp.id(3305672891634119)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3306279137634120)
,p_plug_template_id=>wwv_flow_imp.id(3305672891634119)
,p_name=>'Tabs'
