...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3246980740634104)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3247220123634104)
,p_plug_template_id=>wwv_flow_imp.id(3246980740634104)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3247539875634104)
,p_plug_template_id=>wwv_flow_imp.id(3246980740634104)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3247814879634104)
,p_plug_template_id=>wwv_flow_imp.id(3246980740634104)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3248124294634105)
,p_plug_template_id=>wwv_flow_imp.id(3246980740634104)
,p_name=>'Sub Regions'
