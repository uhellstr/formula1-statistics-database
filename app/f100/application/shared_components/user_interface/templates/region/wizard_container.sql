...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3313391107634121)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3313669229634121)
,p_plug_template_id=>wwv_flow_imp.id(3313391107634121)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3313966554634121)
,p_plug_template_id=>wwv_flow_imp.id(3313391107634121)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3314298550634121)
,p_plug_template_id=>wwv_flow_imp.id(3313391107634121)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3314570656634121)
,p_plug_template_id=>wwv_flow_imp.id(3313391107634121)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3314837099634121)
,p_plug_template_id=>wwv_flow_imp.id(3313391107634121)
