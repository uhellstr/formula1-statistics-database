...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3293152550634116)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3293494835634117)
,p_plug_template_id=>wwv_flow_imp.id(3293152550634116)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3293731898634117)
,p_plug_template_id=>wwv_flow_imp.id(3293152550634116)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3294063048634117)
,p_plug_template_id=>wwv_flow_imp.id(3293152550634116)
,p_name=>'Sub Regions'
