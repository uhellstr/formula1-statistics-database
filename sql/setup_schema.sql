...
BEGIN
  ...
  INTO lv_count
  FROM DBA_USERS
  WHERE USERNAME = 'F1_STAGING';

  IF lv_count > 0 THEN
    EXECUTE IMMEDIATE 'DROP USER F1_STAGING CASCADE';
  END IF;
...
-- USER SQL
CREATE USER "F1_STAGING" IDENTIFIED BY "oracle"
DEFAULT TABLESPACE "USERS"
TEMPORARY TABLESPACE "TEMP";

-- QUOTAS
ALTER USER "F1_STAGING" QUOTA UNLIMITED ON "USERS";

-- ROLES
GRANT "CONNECT" TO "F1_STAGING" ;
ALTER USER "F1_STAGING" DEFAULT ROLE "CONNECT";

-- SYSTEM PRIVILEGES
GRANT CREATE PROCEDURE TO "F1_STAGING" ;
GRANT CREATE TRIGGER TO "F1_STAGING" ;
GRANT CREATE VIEW TO "F1_STAGING" ;
GRANT CREATE SESSION TO "F1_STAGING" ;
GRANT CREATE TABLE TO "F1_STAGING" ;
GRANT CREATE SEQUENCE TO "F1_STAGING" ;
GRANT CREATE EVALUATION CONTEXT TO "F1_STAGING";
...
GRANT SELECT ON DBA_OBJECTS TO "F1_DATA" ;
...
GRANT CREATE TRIGGER TO "F1_LOGIK" ;
GRANT EXECUTE ANY PROGRAM TO "F1_LOGIK" ;
GRANT CREATE PROCEDURE TO "F1_LOGIK" ;
GRANT CREATE TABLE TO "F1_LOGIK" ;
GRANT CREATE VIEW TO "F1_LOGIK" ;
...
GRANT CREATE TABLE TO "F1_ACCESS" ;
GRANT CREATE PROCEDURE TO "F1_ACCESS" ;
GRANT CREATE TRIGGER TO "F1_ACCESS" ;
...
GRANT CREATE TABLE TO "F1_REST_ACCESS" ;
GRANT CREATE VIEW TO "F1_REST_ACCESS" ;
GRANT CREATE TABLE TO "F1_REST_ACCESS" ;
GRANT CREATE PROCEDURE TO "F1_REST_ACCESS" ;
GRANT CREATE TRIGGER TO "F1_REST_ACCESS" ;
