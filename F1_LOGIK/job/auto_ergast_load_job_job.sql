...
sys.dbms_scheduler.set_attribute('"AUTO_ERGAST_LOAD_JOB"','NLS_ENV','NLS_LANGUAGE=''SWEDISH'' NLS_TERRITORY=''SWEDEN'' NLS_CURRENCY=''Kr'' NLS_ISO_CURRENCY=''SWEDEN'' NLS_NUMERIC_CHARACTERS='',.'' NLS_CALENDAR=''GREGORIAN'' NLS_DATE_FORMAT=''RRRR-MM-DD HH24:MI:SS'' NLS_DATE_LANGUAGE=''SWEDISH'' NLS_SORT=''SWEDISH'' NLS_TIME_FORMAT=''HH24:MI:SSXFF'' NLS_TIMESTAMP_FORMAT=''RRRR-MM-DD HH24:MI:SSXFF'' NLS_TIME_TZ_FORMAT=''HH24:MI:SSXFF TZR'' NLS_TIMESTAMP_TZ_FORMAT=''RRRR-MM-DD HH24:MI:SSXFF TZR'' NLS_DUAL_CURRENCY=''€'' NLS_COMP=''BINARY'' NLS_LENGTH_SEMANTICS=''BYTE'' NLS_NCHAR_CONV_EXCP=''FALSE''');
